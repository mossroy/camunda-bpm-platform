...
public class HistoricProcessInstanceManager extends AbstractHistoricManager {
  ...
  public Map<Class<? extends DbEntity>, DbOperation> addRemovalTimeById(String processInstanceId, Date removalTime, Integer batchSize, Set<String> entities, List<ImmutablePair<String, DbCall>> operations) {
    CommandContext commandContext = getCommandContext();
